...
from robust_svm.image_processing_utils import image_to_feature_vector, hog_transformation
...
for data_path in data_paths:
    ...
    datasets_list = ['00013','00014','00015','00017','00019']
    for dataset in datasets_list:
        image_dataset_path = join(images_folder, dataset)
        feature_dataset_path = join(features_folder, dataset)
        if not exists(feature_dataset_path):
            makedirs(feature_dataset_path)
        ...
        for each_annotation in annotated_data:
            ...
            if image_filename in all_images:
                ...
                feature_vector = hog_transformation(image_dataset_path, each_annotation)
